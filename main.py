...
if __name__ == "__main__":
    ...
    while True:
        ...
        print("Call Details:")
        region_map = {1: "American Region", 2: "Asian Region", 3: "African Region", 4: "European Region"}
        region = region_map.get(destination_code, "Unknown Region")
        ...
        print()
        choice = input("Do you want to calculate another call? [Y/N] ").upper()
        if choice != 'Y':
            print("Thank you for using the Telephone Cost Calculator. Goodbye!")
            break
